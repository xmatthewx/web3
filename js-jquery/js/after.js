...
function dotsAppend(){
    // console.log('append');
    $('#dotTemplate').remove();
    $('#dot-canvas').append(dots);
    
    // add event listener
    $('#dot-canvas').on('mouseenter','.dot',function(event){ dotAction(this) });
}
 ...
 * make words
 */
function wordsInit(count,callback){
 ...
 * display words
 */
function wordsAppend(){
    console.log('wordsappend');
    $('#wordTemplate').remove();
    $('#word-canvas').append(words);
    $('#word-canvas').on('mouseenter','.word',function(event){ wordAction(this) });
}
...
/**
 * init words
 * @see switch keypress below
 */
var wordsGo = wordsInit(kafka.length,wordsAppend);


/**
 * switch between words and dots on keypress
 */
